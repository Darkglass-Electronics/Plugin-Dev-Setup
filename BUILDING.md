...
For this step we make use of [crosstool-ng](https://crosstool-ng.github.io/) running through our [plugin-builder](https://github.com/Darkglass-Electronics/plugin-builder/).  
